...
export default function PlayPageClient() {
  ...
  class CustomHlsJsLoader extends Hls.DefaultConfig.loader {
    ...
    load(context: any, config: any, callbacks: any) {
            ...
            if (response.data && typeof response.data === 'string') {
              ...
              if (
                ...
                try {
                  ...
                  console.error('❌ 解析广告规则规则 Function 失败:', err);
                }
              } else {
      ...
      super.load.call(this, context, config, finalCallbacks);
    }
  }
  ...
  useEffect(() => {
    ...
    try {
        ...
        layers: [
          {
            name: 'top-bar',
            html: `
            <div id="custom-top-bar" class="custom-top-bar">
              <div class="top-bar-left">
                <span id="exit-fullscreen-btn" class="exit-fullscreen-btn" style="display:none;cursor:pointer">
              ...
              <div class="top-bar-center">
                <span id="video-title-text" class="video-title">${
                  detail?.episodes_titles?.[currentEpisodeIndexRef.current] ||
      ...
      // 监听播放器事件
      artPlayerRef.current.on('control', (state: any) => {
        const topBar = document.getElementById('custom-top-bar');
        if (topBar) {
      ...
      artPlayerRef.current.on('fullscreen', (state: any) => {
        const topBar = document.getElementById('exit-fullscreen-btn');
        if (topBar) {
          topBar.style.display = state ? 'block' : 'none';
        }
      });
          ...
          <div className='text-center max-w-md mx-auto px-6'>
            ...
            <div className='space-y-3'>
              <button
                ...
                className='w-full px-6 py-3 bg-linear-to-r from-primary-500 to-primary-600 text-white rounded-xl font-medium hover:from-primary-600 hover:to-primary-700 transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-xl'
              >
            ...
            >
              <div className='relative w-full h-75 lg:h-full'>
                ...
                <style>
                  ...
                  .art-video-player.art-fullscreen .custom-top-bar {
                    padding-top: 10px;
                  }
                  .art-layer-top-title {
                    opacity: 0;
                  ...
                  .art-video-player.art-control-show .art-layer-top-title {
                    opacity: 1;
                  }
                `}
                </style>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
          ...
          <div className='md:col-span-3'>
            <div className='p-6 flex flex-col min-h-0'>
              ...
              {/* 关键信息行 */}
              <div className='flex flex-wrap items-center gap-3 text-base mb-4 opacity-80 shrink-0 text-gray-900 dark:text-gray-100'>
                {detail?.class && (
              ...
              {detail?.desc && (
                <div
                  className='mt-0 text-base leading-relaxed opacity-90 overflow-y-auto pr-2 flex-1 min-h-0 scrollbar-hide text-gray-900 dark:text-gray-100'
                ...
                {videoCover ? (
                  <>
                    ...
                    {videoDoubanId !== 0 && (
                      ...
                      >
                        <div className='bg-primary-500 text-white text-xs font-bold w-8 h-8 rounded-full flex items-center justify-center shadow-md hover:bg-primary-600 hover:scale-[1.1] transition-all duration-300 ease-out'>
                          <svg
                            width='16'
                            height='16'
                            viewBox='0 0 24 24'
