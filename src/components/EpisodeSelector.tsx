      ...
      {activeTab === 'episodes' && (
        <>
          ...
          <div className='flex items-center gap-4 mb-4 border-b border-gray-300 dark:border-gray-700 -mx-6 px-6 shrink-0'>
            ...
            {/* 向上/向下按钮 */}
            <button
              className='shrink-0 w-8 h-8 rounded-md flex items-center justify-center text-gray-700 hover:text-primary-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:text-primary-400 dark:hover:bg-white/20 transition-colors transform -translate-y-1'
              onClick={() => {
                // 切换集数排序（正序/倒序）
                                ...
                                if (!videoInfo.hasError) {
                                  return (
                                    <div className='flex items-end gap-3 text-xs'>
                                      <div className='text-primary-600 dark:text-primary-400 font-medium text-xs'>
                                        {videoInfo.loadSpeed}
                                      </div>
