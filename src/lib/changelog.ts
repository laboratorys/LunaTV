...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    changed: ['【播放源】增加关键字搜索、页面交互优化', '主题菜单优化'],
    fixed: [
      '【TVBox】开关状态显示错误',
      '【TVBox】优化短剧精准查询',
      '【TVBox】豆瓣推荐数据过滤榜单类型',
  ...
  },
  {
    ...
    changed: ['【tvbox】增加接口缓存、超时、豆瓣配置读取优化、搜索接口修改'],
    fixed: [
      // 无修复内容
    ],
  },
  {
    version: '5.0.2',
    date: '2025-09-05',
    added: ['TvBox支持', '【继续观看】增加展开收起/按钮'],
    changed: ['【直播】添加了对flv、mp4格式的支持'],
    fixed: ['【后台管理】点击Tab控制台错误', '查看版本信息页面闪烁'],
  },
  {
    version: '5.0.1',
    date: '2025-09-01',
